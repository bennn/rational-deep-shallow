...
(module* admin typed/racket/base
  (require (submod "..") require-typed-check "../base/types.rkt" "board-adapted.rkt" "state-adapted.rkt")
  ...
  (provide (all-from-out (submod "..")) tree-state lplaced% generate-tree tree-next))
