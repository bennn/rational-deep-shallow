...
(module* admin typed/racket
  ...
  (provide (all-from-out (submod "..")) state-current-player state-sub-shares player0 *create-player state0 state-place-tile state-buy-shares state-return-shares state-move-tile state-next-turn state-remove-current-player state-eliminate state-score state-final?  *create-state *cs0))
