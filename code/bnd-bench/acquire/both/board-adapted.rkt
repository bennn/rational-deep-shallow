...
(module* admin typed/racket/base
  ...
  (provide (all-from-out (submod "..")) tile<=?  tile->string ALL-TILES STARTER-TILES# FOUNDING GROWING MERGING SINGLETON IMPOSSIBLE *create-board-with-hotels affordable?  board-tiles  deduplicate/hotel distinct-and-properly-formed found-hotel free-spot?  grow-hotel growing-which make-board merge-hotels merging-which place-tile set-board size-of-hotel what-kind-of-spot))
